...
def tweetRumorclassification(tweetid, isRT, hasBeenRT, isReply, retweet_count, tweet_text):  
    ...
    if isReply=='False':
        isreply='NO'
    x=[isrt,hasbeenrt, isreply,retweet_count]    
    unlabeled=x+tweetinfo
    print unlabeled
...
#print tweetRumorclassification(727449104796668000,'False','False','True',0,'What is #ZikaVirus, how you catch it and how to avoid it too! via @DrMelOB @wanderlustmag https://t.co/W5THhv2Pgh #publichealth')
